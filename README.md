...
This section shows the viewers three cards with distinct images, each having a corresponding image, card-title, and description. Furthermore, ech card has a button that, when clicked, sends the viewer to the prices.html page. 
